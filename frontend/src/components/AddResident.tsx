...
function AddResidentModal(props: AddResidentModalProps): JSXElement {
  ...
  const [editRoom, setEditRoom] = createSignal<buildRoom>({ pod: 'A', roomNumber: "1", bunk: 'T' });
  ...
  const handleSubmit = async () => {
    ...
    setNewResident({ ...newResident(), room: `${buildRoom.pod}-${buildRoom.roomNumber}${buildRoom.bunk}` });
      ...
      <div class="modal modal-open">
        <div class="modal-box">
          ...
          <div class="grid grid-cols-3 gap-4">
            ...
            <select class="select select-bordered" onChange={(e) => updateRoom('roomNumber', e.currentTarget.value)}>
            ...
            <select class="select select-bordered" onInput={(e) => updateField('level', parseInt(e.currentTarget.value))}>
